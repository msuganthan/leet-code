 ...
 * array that contains the answers of the ith student (0-indexed). The answers of the mentors are represented
 * by a 2D integer array mentors where mentors[j] is an integer array that contains the answers of the jth
 * mentor (0-indexed).
 *
 * Each student will be assigned to one mentor, and each mentor will have one student assigned to them.
 * The compatibility score of a student-mentor pair is the number of answers that are the same for both the
 ...
 *
 * You are tasked with finding the optimal student-mentor pairings to maximize the sum of the compatibility
 * scores.
 *
